...
def record_stats(target, timeout, count, target_url, output):
    ...
    # This section is checking to see if the connection to the gateway works.
...
# This section starts getting the json data about the modem.
    ...
    # This section is all about putting it in to a result format for adding to CSV.
    data = [
        ['datetime',
...
def main():
    ...
    target_domain = 't-mobile.com'

    timeout_seconds = 30
    simultaneous_pings = 1

    result = dns.resolver.resolve(target_domain, lifetime=timeout_seconds)

    target_url = 'https://www.t-mobile.com/'
